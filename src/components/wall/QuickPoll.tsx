...
export const QuickPoll = ({ content, itemId, currentUserId }: QuickPollProps) => {
  ...
  return (
    <Card className="p-4 bg-gradient-to-br from-pink-50 to-purple-50 dark:from-pink-950/20 dark:to-purple-950/20 border-2 border-pink-200 dark:border-pink-800 w-[280px]">
            ...
            >
              ...
              <div className="relative z-10 flex items-center justify-between w-full">
                ...
                <div className="flex items-center gap-2">
                  {hasVoted && <span className="text-sm font-bold">{Math.round(percentage)}%</span>}
